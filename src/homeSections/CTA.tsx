  ...
  return (
    <section className="py-16 bg-emerald-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-indigo-500 rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="px-6 py-12 sm:px-12 lg:py-16">
              ...
              <div className="mt-8">
                {status === "authenticated" ? (
                  <Link
                    href="/streak"
                    className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-600 bg-white hover:bg-indigo-50 transition duration-300"
                  >
                    View Your Streak
                  </Link>
                ) : (
                ...
                <div className="relative h-full grid grid-cols-7 grid-rows-5 gap-1 p-8">
                  {[...Array(35)].map((_, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={`${opacity} rounded-sm w-full h-full`}
                      ></div>
                    );
                  })}
                </div>
              ) : (
                <div className="h-full bg-indigo-600/50 p-8"></div>
              )}
            </div>
          </div>
        </div>
